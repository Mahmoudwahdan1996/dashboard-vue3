<template>
  <div>
    <BreadCrumb>
      <template #actions>
        <router-link to="/products/add" v-slot="{ href, navigate }" custom>
          <Button
    ...
    >
      ...
      <template #content>
        <FilterProducts :filters="filters" @resetFilters="resetFilters" />
...
import FilterProducts from "@/components/products/filter.vue";
